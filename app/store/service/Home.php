...
class Home extends BaseService
{
    ...
    /* @var BalanceLogModel $balanceLogModel */
    private $balanceLogModel;
    ...
    public function __construct()
    {
        ...
        $this->BalanceLogModel = new BalanceLogModel;
    }
    ...
    public function getData(): array
    {
        ...
        $data = [
            ...
            'statistics' => [
                ...
                //返佣总额
                'balanceTotal' => $this->getBalanceTotal(),
            ],
            // 待办事项
            'pending' => [
                // 待发货订单
     ...
     * @return string
     */
    private function getBalanceTotal()
    {
        return $this->BalanceLogModel->getBalanceTotal(['scene' => SceneEnum::RETURNPRICE]);
    }
